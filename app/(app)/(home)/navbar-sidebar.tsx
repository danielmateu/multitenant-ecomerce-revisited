            ...
            <SheetContent side="left" className="p-0 transition-none">
                ...
                <ScrollArea className="flex flex-col overflow-y-auto h-full pb-2">
                    ...
                    <div className="border-t">
                        ...
                        <Link href={'/sign-in'} className="w-full text-left p-4 hover:bg-black hover:text-white flex items-center text-base font-medium" onClick={() => onOpenChange(false)}>Sign Up</Link>
                    </div>
                </ScrollArea>
            </SheetContent>
        </Sheet>
